			...
			<div class="pd-20 card-box mb-30">
				...
				<form action="" method="post" class="form-horizontal">
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-10">
							<input type="text" class="form-control" readonly name="tanggal_dibuat" id="tanggal_dibuat" placeholder="Tanggal Dibuat" value="<?php echo formatTanggal($tanggal_dibuat); ?>" />
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-10">
							<input type="text" class="form-control" readonly name="is_payment" id="is_payment" placeholder="Is Payment" value="<?php echo $is_payment == 1 ? "Valid" : "Tidak Valid"; ?>" />
						</div>
					</div>
								...
								<script>
									$(document).ready(function() {
										dataTable = $('#example1').DataTable({
											...
											"ajax": {
												url: "<?php echo site_url('pesanan/fetch_data_pesanan'); ?>",
												type: "POST",
												dataSrc: "data",
												data: function(d) {
													d.kode = "<?= $kode_pesanan ?>";
