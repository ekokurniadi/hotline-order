                ...
                <form action="" method="post" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Nomor Mesin <?php echo form_error('nomor_mesin') ?></label>
                          <div class="col-sm-12 col-md-10">
                            <input type="text" class="form-control" readonly name="nomor_mesin" id="nomor_mesin" placeholder="Nomor Mesin" value="<?php echo $nomor_mesin; ?>" />
                          </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Nomor Plat Kendaraan <?php echo form_error('nomor_plat_kendaraan') ?></label>
                          <div class="col-sm-12 col-md-10">
                            <input type="text" class="form-control" readonly name="nomor_plat_kendaraan" id="nomor_plat_kendaraan" placeholder="Nomor Plat Kendaraan" value="<?php echo $nomor_plat_kendaraan; ?>" />
                          </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Foto Stnk <?php echo form_error('foto_stnk') ?></label>
                          <div class="col-sm-12 col-md-10">
                            <input type="text" class="form-control" readonly name="foto_stnk" id="foto_stnk" placeholder="Foto Stnk" value="<?php echo $foto_stnk; ?>" />
                          </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Foto Ktp <?php echo form_error('foto_ktp') ?></label>
                          <div class="col-sm-12 col-md-10">
                            <input type="text" class="form-control" readonly name="foto_ktp" id="foto_ktp" placeholder="Foto Ktp" value="<?php echo $foto_ktp; ?>" />
                          </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                        <textarea class="form-control" rows="3" readonly name="alamat_sesuai_ktp" id="alamat_sesuai_ktp" placeholder="Alamat Sesuai Ktp"><?php echo $alamat_sesuai_ktp; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Nomor Hp <?php echo form_error('nomor_hp') ?></label>
                          <div class="col-sm-12 col-md-10">
                            <input type="text" class="form-control" readonly name="nomor_hp" id="nomor_hp" placeholder="Nomor Hp" value="<?php echo $nomor_hp; ?>" />
                          </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                        <textarea class="form-control" rows="3" readonly name="catatan" id="catatan" placeholder="Catatan"><?php echo $catatan; ?></textarea>
                        </div>
                    </div>
