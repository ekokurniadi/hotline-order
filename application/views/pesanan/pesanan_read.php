            ...
            <div class="pd-20 card-box mb-30">
                ...
                <form action="" method="post" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                        <textarea class="form-control" rows="3" readonly name="keterangan" id="keterangan" placeholder="Keterangan"><?php echo $keterangan; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Foto Motor <?php echo form_error('foto_motor') ?></label>
                          <div class="col-sm-12 col-md-10">
                            <input type="text" class="form-control" readonly name="foto_motor" id="foto_motor" placeholder="Foto Motor" value="<?php echo $foto_motor; ?>" />
                          </div>
                    </div>
